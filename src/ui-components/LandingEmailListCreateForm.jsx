...
import { createLandingEmailList } from "../../mutations";
const client = generateClient();
export default function LandingEmailListCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setIsForSurvey(initialValues.isForSurvey);
    setIsForSubscription(initialValues.isForSubscription);
    setErrors({});
  };
  const validations = {
    email: [{ type: "Email" }],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createLandingEmailList.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "LandingEmailListCreateForm")}
      {...rest}
    >
      <TextField
        label="Email"
